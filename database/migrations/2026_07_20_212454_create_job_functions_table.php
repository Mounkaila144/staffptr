...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::connection($connectionName)->create('job_functions', function (Blueprint $table): void {
            $table->id();
        ...
        $this->grantApplicationUpdate($connectionName, 'job_functions');
    }
    ...
    public function down(): void
    {
        ...
        $this->revokeApplicationUpdate($connectionName, 'job_functions');
        Schema::connection($connectionName)->dropIfExists('job_functions');
    }
