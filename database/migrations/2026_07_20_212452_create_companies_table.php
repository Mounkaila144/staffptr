...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::connection($connectionName)->create('companies', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unsignedTinyInteger('singleton_lock')->storedAs('1');
            $table->unique('singleton_lock', 'companies_singleton_unique');
            $table->timestamps(precision: 3);
        });

        $this->grantApplicationUpdate($connectionName, 'companies');
    }
    ...
    public function down(): void
    {
        ...
        $this->revokeApplicationUpdate($connectionName, 'companies');
        Schema::connection($connectionName)->dropIfExists('companies');
    }
