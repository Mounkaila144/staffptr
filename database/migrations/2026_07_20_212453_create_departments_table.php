...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::connection($connectionName)->create('departments', function (Blueprint $table): void {
            $table->id();
        ...
        $this->grantApplicationUpdate($connectionName, 'departments');
    }
    ...
    public function down(): void
    {
        ...
        $this->revokeApplicationUpdate($connectionName, 'departments');
        Schema::connection($connectionName)->dropIfExists('departments');
    }
