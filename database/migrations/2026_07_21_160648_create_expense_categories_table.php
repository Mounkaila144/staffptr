...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::connection($connectionName)->create('expense_categories', function (Blueprint $table): void {
            $table->id();
        ...
        $this->grantApplicationUpdate($connectionName, 'expense_categories');
    }
    ...
    public function down(): void
    {
        ...
        $this->revokeApplicationUpdate($connectionName, 'expense_categories');
        Schema::connection($connectionName)->dropIfExists('expense_categories');
    }
