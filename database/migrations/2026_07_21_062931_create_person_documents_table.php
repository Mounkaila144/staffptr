...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::connection($connectionName)->create('person_documents', function (Blueprint $table): void {
            $table->id();
        ...
        $this->grantApplicationUpdate($connectionName, 'person_documents');
    }
    ...
    public function down(): void
    {
        ...
        $this->revokeApplicationUpdate($connectionName, 'person_documents');
        Schema::connection($connectionName)->dropIfExists('person_documents');
    }
